...
7. **管辖边界**（2026-09-10 用户裁）：ome 保留自身代码、功能、发版与二进制自更新；ome 所管软件的清单发布更新与资源播种分发运营托管 omc（catalog 数据权威仍在 ome 仓唯一 pin 源；承接形态由 omc 定：消费现供给零迁移，或接管签名与播种流水移转 `CATALOG_SIGNING_KEY`；承接期间 ome 仓流水不撤保供给连续）。三流程标准见 R015。
