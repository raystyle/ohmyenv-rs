...
| M102 | `docs\mistakes\M102-解压与安装-错误.md` | 解压与安装错误（九分派、防穿越、幂等；M002 测试沙盒漏 catalog；M004 上游布局变更致展平误判；M017 管道未抽干致 post_install 假超时；M021 杀进程树顺序错致 taskkill 无效） | M002、M004、M017、M021 |
