...
| M105 | `docs\mistakes\M105-工具链与脚本-错误.md` | 工具链与脚本错误（sed、grep、PowerShell、中文路径；M005 Set-Content -NoNewline；M012 种子差集未 HEAD；M015 边车写源目录；M016 cfg 门控面漏跑矩阵；M018 盲切删段连带删掉相邻用例） | M005、M006、M012、M015、M016、M018 |
