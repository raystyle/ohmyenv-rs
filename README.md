...
**Oh My Env**：本机跨平台（Windows / Linux / macOS）环境部署管理 CLI，管 41 个工具与运行时
...
| 远程服务依赖（1） | openssh |
| 密钥安全管理（2） | age、sops |
| 命令工具依赖（18） | git、gh、aria2、7z、gsudo、oscdimg、rg、jq、mq、yq、starship、just、ast-grep、rumdl、shellcheck、zoxide、sheldon、ffmpeg |
